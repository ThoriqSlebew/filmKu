...
$no = 1;
$data_kategori = $abc->tampil_semua_kategori();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="user d-flex flex-column gap-2" enctype="multipart/form-data" action="../proses_kategori.php" method="post">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-dark" href="../proses_kategori.php?aksi=hapus&id_kategori=<?= $kategori->id_kategori ?>">Hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="user d-flex flex-column gap-2" action="../proses_kategori.php" method="post">
                        <!-- <input type="hidden" class="form-control" name="id_kategori" value=""> -->
    ...
    <div class="d-flex justify-content-around pt-5">
        <div class="col-4">
            <h1>Film-Ku</h1>
            <p>
                Film-Ku Mantab adalah perpustakaan digital yang menyediakan akses mudah ke berbagai koleksi film, jurnal, dan sumber daya lainnya secara online. Nikmati kebebasan membaca dan belajar di mana saja, kapan saja.
            </p>
        </div>
        <div class="col-4">
            <h3>Discover More!</h3>
            <p>
                Temukan berbagai koleksi yang menarik dan bermanfaat di Film-Ku Mantab. Tersedia film-film terbaru, jurnal ilmiah, majalah populer, dan banyak lagi. Tingkatkan pengetahuan Anda dengan menjelajahi dunia pengetahuan yang tak terbatas.
            </p>
    </div>
</footer>
