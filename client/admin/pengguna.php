                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="user d-flex flex-column gap-2" enctype="multipart/form-data" action="../proses_pengguna.php" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="no_telp" value="<?= $pengguna->no_telp ?>" required>
                                                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-dark" href="../proses_pengguna.php?aksi=hapus&id_pengguna=<?= $pengguna->id_pengguna ?>">Hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="user d-flex flex-column gap-2" enctype="multipart/form-data" action="../proses_pengguna.php" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="No" name="no_telp" required>
                        </div>
